...
export class TopbarMyPageComponent implements OnInit, AfterViewInit {
  ...
  extrasCustomDisplay: boolean;
  extrasUserLayout: 'offcanvas' | 'dropdown';
  extrasCustomLayout: 'offcanvas' | 'dropdown';
  isToggleFont : boolean = false;

  constructor(private layout: LayoutService, private auth: AuthService) {
    this.isToggleFont = JSON.parse(localStorage.getItem('isSmallFont'))
  ...
  toggle() {
    this.isToggleFont  = !this.isToggleFont;
    localStorage.setItem('isSmallFont',JSON.stringify(this.isToggleFont));
  }
}
