...
export class LayoutComponent implements OnInit, AfterViewInit {
  ...
  extrasCustomOffcanvasDisplay = false;
  ...
  ngOnInit(): void {
    ...
    if (this.layout.getProp('extras.custom.display')) {
      this.extrasCustomOffcanvasDisplay =
        this.layout.getProp('extras.custom.layout') === 'offcanvas';
    }
